...
本项目基于 鱼香ROS教程第七章结尾处自动巡检机器人，并使用了C++语言进行改编。
...
- autopatrol_robot_cpp  自动巡检实现功能包

主要更改点:
- 将语言由python修改为cpp
- 去除了原patrol_node.cpp中的初始化函数，改为直接在fishbot_navigation2/config/nav2_params.yaml下初始化位姿
- 使用命令行工具调用语音合成系统
...
```
source install/setup.bash
ros2 launch autopatrol_robot_cpp autopatrol.launch.py
```

## 3.作者

- 原作者: [fishros](https://github.com/fishros)
- me: [YoungQ](https://github.com/yq53)